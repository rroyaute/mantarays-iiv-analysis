...
# TODO: change legend order

# Import rptR objects ----
# Import foraging strategy variance
rpt.V.solo.v.g = read_rds(file = here("outputs/mods/rpt.V.solo.v.g_site_rd.rds"))
rpt.r2.solo.v.g = read_rds(file = here("outputs/mods/rpt.r2.solo.v.g_site_rd.rds"))
