...
## What explains variation in group leadership? (TODO)
...
# Store effect sizes
df.sex.2  = data.frame(delta_r2_Vi = r2_Vi_f - r2_Vi_m,
...
# Store effect sizes
df.mat.2  = data.frame(delta_r2_Vi = r2_Vi_j - r2_Vi_a,
                   delta_r2_Vfe = r2_Vfe_j - r2_Vfe_a,
                   delta_r2_VR = r2_VR_j - r2_VR_a)
```
...
# Store effect sizes
df.inj.2  = data.frame(delta_r2_Vi = r2_Vi_ni - r2_Vi_i,
                   delta_r2_Vfe = r2_Vfe_ni - r2_Vfe_i,
                   delta_r2_VR = r2_VR_ni - r2_VR_i)
```
...
```{r}
tbl_delta_r2_sex = describe_posterior(df.sex.2) %>% 
  data.frame() %>% 
...
tbl_delta_r2_maturity = describe_posterior(df.mat.2) %>% 
  data.frame() %>% 
  mutate("Variance_component" = as.factor(Parameter)) %>% 
  mutate(Variance_component = fct_recode(Variance_component, 
             Delta_Vi = "delta_r2_Vi",
...
tbl_delta_r2_injury = describe_posterior(df.inj.2) %>% 
  data.frame() %>% 
  mutate("Variance_component" = as.factor(Parameter)) %>% 
  mutate(Variance_component = fct_recode(Variance_component, 
             Delta_Vi = "delta_r2_Vi",
